...
{if isset($js_defer) && !$js_defer && isset($js_files) && isset($js_def)}
		...
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/cube.css">
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/authentication-mod.css">
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/breadcrumb-mod.css">
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/my-account-mod.css">
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/product-mod.css">
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/category-mod.css">
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/order-mod.css">
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/off-canvas-nav-mod.css">
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/new-products-mod.css">
		<link rel="stylesheet" type="text/css" href="{$content_dir}themes/{$LEO_THEMENAME}/css/manufacturers-mod.css">
		<link rel="icon" type="image/png" href="{$content_dir}themes/{$LEO_THEMENAME}/media/cuber-favicon-0064x0064.png">
		<link rel="apple-touch-icon" href="{$content_dir}themes/{$LEO_THEMENAME}/media/cuber-favicon-0144x0144.png">
		...
		<script src='{$content_dir}themes/{$LEO_THEMENAME}/js/cube/cuber.min.js'></script>
		<script src='{$content_dir}themes/{$LEO_THEMENAME}/js/photon.js'></script>
		<!--[if IE 8]>
	...
	<script>
		...
		var container 	= document.querySelector( '#cube-content' ),
			cube 		= new ERNO.Cube();
