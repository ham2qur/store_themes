...
<p class="intro">{l s='This page allows you to manage your or your addresses; You have the opportunity to learn one or more. For example, you can save a shipping address and a billing address if you want to differentiate. In this case, remember to give a title to your addresses to find them more easily. If your delivery address is the same as your billing address, complete it and check the box "Use the same address for billing" in your cart.'}</p>
