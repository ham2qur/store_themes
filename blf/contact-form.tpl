...
{capture name=path}<a href="{$link->getCMSCategoryLink(2)|escape:'html'}">{l s='Customers service'}</a><span class="navigation-pipe">{$navigationPipe}</span>{l s='Contact'}{/capture}
