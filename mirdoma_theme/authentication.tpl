...
<!--				<p class="title_block">{l s='Please enter your email address to create an account.'}</p> -->
				...
				<p class="text">
					...
					<input placeholder="E-mail" type="text" id="email_create" name="email_create" value="{if isset($smarty.post.email_create)}{$smarty.post.email_create|stripslashes}{/if}" class="account_input" />
				</p>
				<p class="submit">
					{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back}" />{/if}
					<input style="margin-left: 108px;" type="submit" id="SubmitCreate" name="SubmitCreate" class="btn btn-success" value="{l s='Create an account'}" />
		...
		<fieldset>
			...
			<div class="form_content clearfix">
				<p class="text">
					...
					<input placeholder="E-mail" type="text" id="email" name="email" value="{if isset($smarty.post.email)}{$smarty.post.email|stripslashes}{/if}" class="account_input" />
				</p>
				<p class="text">
					<label for="passwd">{l s='Password'}</label>
					<input placeholder="Пароль" type="password" id="passwd" name="passwd" value="{if isset($smarty.post.passwd)}{$smarty.post.passwd|stripslashes}{/if}" class="account_input" />
				</p>
				<p class="submit">
					{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
					<input style="margin-left: 108px;" type="submit" id="SubmitLogin" name="SubmitLogin" class="btn btn-success" value="{l s='Log in'}" /> <a href="{$link->getPageLink('password')|escape:'html'}" title="{l s='Recover your forgotten password'}" rel="nofollow">{l s='Forgot your password?'}</a>
				</p>
			</div>
		</fieldset>
	</form>
...
<!-- 		<h3>{l s='Your personal information'}</h3>
		...
		<p class="required password">
			...
			<input type="password" class="text" name="passwd" id="passwd" placeholder="{l s='(Five characters minimum)'}" />
		</p>
<!-- 		<p class="select">
			<span>{l s='Date of Birth'}</span>
			<select id="days" name="days">
	...
	<p class="cart_navigation required submit">
		...
		{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
		<input type="submit" name="submitAccount" id="submitAccount" value="{l s='Register'}" class="btn btn-success" />
	</p>
</form>
{/if}
