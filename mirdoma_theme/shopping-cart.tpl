...
<div id="order-detail-content" class="table_block">
	<table id="cart_summary" class="std table table-bordered table-striped table-condensed">
		<thead>
			<tr>
		...
		{/if}
			...
			<tr class="cart_total_price">
				...
				<td colspan="2" class="price total_price_container" id="total_price_container">
					<p>{l s='Total'} <span id="total_price">{displayPrice price=$total_price}</span></p>
				</td>
				{else}
				<td colspan="2" class="price total_price_container" id="total_price_container">
					<p>{l s='Total'}<span id="total_price">{displayPrice price=$total_price_without_tax}</span></p>
				</td>
				{/if}
			</tr>
		</tfoot>
