...
<div id="special_block_right" class="block products_block exclusive blockspecials">
	<h4 class="title_block"><a href="{$link->getPageLink('prices-drop')|escape:'html'}">{l s='Specials' mod='blockspecials'}</a></h4>
	<div class="block_content">

{if $special}
		<ul class="products clearfix unstyled">
			<li class="product_image clearfix">
				...
				{if !$PS_CATALOG_MODE}
					{if $special.specific_prices}
						...
						<div id="reduction_specials" class="popover right">
							<div class="arrow"></div>
							<div class="popover-content"><span class="reduction">-{$specific_prices.reduction*100|floatval}%</span></div>
						</div>
						{/if}
					{/if}
				{/if}
		...
		<p>
			<a href="{$link->getPageLink('prices-drop')|escape:'html'}">{l s='All specials' mod='blockspecials'} <i class="icon-arrow-right"></i></a>
		</p>
{else}
