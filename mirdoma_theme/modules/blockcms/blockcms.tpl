...
{else}
	...
	<div class="block_various_links span3" id="block_various_links_footer">
		...
		<ul>
			<li class="item"><a href="http://www.mirdoma.com.ua/contact-form.php" title="Контакты">Контакты</a></li>
			<li class="item"><a href="http://www.mirdoma.com.ua/content/1-dostavka-i-oplata" title="Доставка и оплата">Доставка и оплата</a></li>
