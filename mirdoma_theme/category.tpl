...
{if isset($category)}
	{if $category->id AND $category->active}
		...
		<div class="resumecat category-product-count muted">
...
<!-- 				{if $category->id_image}
		...
		<div id="subcategories">
			...
			{foreach from=$subcategories item=subcategory}
				<li class="span2">
					<a href="{$link->getCategoryLink($subcategory.id_category, $subcategory.link_rewrite)|escape:'html':'UTF-8'}" class="thumbnail">
						{if $subcategory.id_image}
							<img src="{$link->getCatImageLink($subcategory.link_rewrite, $subcategory.id_image, 'category_md')|escape:'html'}" title="{$subcategory.name|escape:'html':'UTF-8'}" alt="{$subcategory.name|escape:'html':'UTF-8'}" width="157" height="157" />
						{else}
							<img src="{$img_cat_dir}default-category_md.jpg" alt="" width="157" height="157" />
						{/if}
					</a>
