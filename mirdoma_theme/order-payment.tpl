...
{else}
	<div id="opc_payment_methods" class="opc-main-block">
		<div class="title_block">{if !$opc}<h1>{l s='Please choose your payment method'}</h1>{else}<h2><span><span class="label">3</span> {l s='Please choose your payment method'}</span></h2>{/if}</div>
