<div id="opc_new_account" class="opc-main-block">
	...
	<div class="title_block"><h2><span><span class="label">1</span> {l s='Account'}</span></h2></div>
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html'}" method="post" id="login_form" class="form-horizontal std">
		<fieldset>
			<h3>{l s='Already registered?'}</h3>
			<div><a href="#" id="openLoginFormBlock" class="btn btn-info">{l s='Click here'}</a></div>
			<div id="login_form_content" style="display:none;">
				<!-- Error return block -->
				<div id="opc_login_errors" class="error alert alert-error" style="display:none;"></div>
				<!-- END Error return block -->
				<div class="control-group">
					<label class="control-label" for="login_email">{l s='Email address'}</label>
					<div class="controls">
						<input type="text" id="login_email" name="email" placeholder="{l s='E-mail address'}" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="login_passwd">{l s='Password'}</label>
					<div class="controls">
						<input type="password" id="login_passwd" name="login_passwd" placeholder="{l s='Password'}" />
					</div>
				</div>
				<div>
					<div class="controls">
						<p class="submit">
							...
							<input type="submit" id="SubmitLogin" name="SubmitLogin" class="btn btn-large" value="{l s='Login'}" />
						</p>
		...
		<fieldset>
			...
			<div id="opc_account_choice">
				<div class="opc_float">
					...
					<p>
						<input type="button" class="btn btn-info" id="opc_guestCheckout" value="{l s='Guest checkout'}" />
					</p>
				</div>
...
<!-- 					<ul class="bullet">
					...
					<p>
						<input type="button" class="btn btn-info" id="opc_createAccount" value="{l s='Create an account'}" />
					</p>
				</div>
				<div class="clear"></div>
			</div>
			<div id="opc_account_form">
				...
				<!-- Error return block -->
				<div id="opc_account_errors" class="error alert alert-error" style="display:none;"></div>
				<!-- END Error return block -->
				<!-- Account -->
				...
				<p class="required text">
					...
					<input placeholder="E-mail" type="text" class="text" id="email" name="email" value="{if isset($guestInformations) && $guestInformations.email}{$guestInformations.email}{/if}" />
				</p>
				<p class="required password is_customer_param">
					<label for="passwd">{l s='Password'} <sup>*</sup></label>
					<input placeholder="Пароль" type="password" class="text" name="passwd" id="passwd" />
				...
				<p class="required text">
					...
					<input placeholder="Имя" type="text" class="text" id="customer_firstname" name="customer_firstname" onblur="$('#firstname').val($(this).val());" value="{if isset($guestInformations) && $guestInformations.customer_firstname}{$guestInformations.customer_firstname}{/if}" />
				</p>
				<p class="required text">
					<label for="lastname">{l s='Last name'} <sup>*</sup></label>
					<input placeholder="Фамилия" type="text" class="text" id="customer_lastname" name="customer_lastname" onblur="$('#lastname').val($(this).val());" value="{if isset($guestInformations) && $guestInformations.customer_lastname}{$guestInformations.customer_lastname}{/if}" />
				</p>
				<!-- <p class="select">
				...
				<p class="required text">
					...
					<input placeholder="Адрес доставки" type="text" class="text" name="address1" id="address1" value="{if isset($guestInformations) && $guestInformations.address1}{$guestInformations.address1}{/if}" />
				</p>
				...
				<p class="required text">
					...
					<input placeholder="Населенный пункт" type="text" class="text" name="city" id="city" value="{if isset($guestInformations) && $guestInformations.city}{$guestInformations.city}{/if}" />
...
<!-- 				<p class="textarea is_customer_param">
				...
				<p class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}text">
					...
					<input placeholder="Контактный телефон" type="text" class="text" name="phone_mobile" id="phone_mobile" value="{if isset($guestInformations) && $guestInformations.phone_mobile}{$guestInformations.phone_mobile}{/if}" />
				</p>
				<p class="text required is_customer_param">
					<label for="phone">{l s='Home phone'}</label>
					<input placeholder="Дополнительный телефон" type="text" class="text" name="phone" id="phone" value="{if isset($guestInformations) && $guestInformations.phone}{$guestInformations.phone}{/if}" />
				</p>
				...
				<p class="submit">
					<input type="submit" class="exclusive btn btn-success" name="submitAccount" id="submitAccount" value="{l s='Save'}" />
				</p>
				<!-- END Account -->
			</div>
		</fieldset>
	</form>
	<p style="display: none;" id="opc_account_saved" class="alert alert-success">
